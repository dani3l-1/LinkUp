...
- **Dashboard pages no longer start under the logo.** Dashboard content now has consistent top clearance below the centered logo, preventing profile headers and other page content from sliding underneath it.
